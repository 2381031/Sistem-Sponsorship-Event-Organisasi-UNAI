  ...
  const handleCreateEvent = async (e: React.FormEvent) => {
    ...
    try {
      const customPackages = [
        { nama_paket: 'Platinum', persentase_dana: 100, deskripsi_keuntungan: 'Sponsor tunggal, logo eksklusif 100%, media promosi, dokumentasi, publikasi' },
        { nama_paket: 'Gold', persentase_dana: 75, deskripsi_keuntungan: 'Logo 75%, media promosi, dokumentasi, publikasi' },
        { nama_paket: 'Silver', persentase_dana: 25, deskripsi_keuntungan: 'Logo 25%, media promosi, dokumentasi foto' },
        { nama_paket: 'Bronze', persentase_dana: 15, deskripsi_keuntungan: 'Logo 15%, publikasi internal, sertifikat digital' },
      ];
